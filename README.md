...
Drifter is your personal **Cloudflare Workers guardian**. It's a proactive monitoring tool designed to keep your hobby projects and small backends within the free-tier limits. By watching your usage like a hawk, it can automatically trip a "kill switch" (circuit breaker) to prevent unexpected billing surprises.
...
To make the kill switch actually *work*, your other Workers need to check the "Gatekeeper".
